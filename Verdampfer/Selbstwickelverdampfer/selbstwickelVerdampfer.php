...
<body>
    ...
    <div class ="container-fluid" id="wrapper" style="padding-top: 70px;">
        <div id="filterSideBar">
            <?php
            set_include_path('C:\xampp\htdocs\SirDampf\Verdampfer\Selbstwickelverdampfer');
            include('selbstwickelVerdampferFilter.php');
            ?>
        </div>
        <div class="container" id="articleContainer">
            <?php
            $sql_result = get_selbstwickelverdampfer($conn);
            ...
            while($row = mysqli_fetch_array($sql_result))
            {
                ...
                <div class="container" id="article" style="margin: 10px; margin-top: 0; vertical-align: top">
                    <div style="height: 200px;">
                        <a href="http://localhost\SirDampf\produktDetailAnsicht.php?kategorie=verdampfer&id=<?php echo $row['id']; ?>"><img src=<?php echo $row['bild'];?> class="img-responsive" style="width:100%; height: 100%; background-size: cover" alt="Image"></a>
                    </div>
                    <div>
