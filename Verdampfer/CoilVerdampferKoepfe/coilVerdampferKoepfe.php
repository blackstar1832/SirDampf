...
<div class ="container-fluid" id="wrapper" style="padding-top: 70px;">
    <div id="filterSideBar">
        <?php
        set_include_path('C:\xampp\htdocs\SirDampf\Verdampfer\coilVerdampferKoepfe');
        include('coilVerdampferKoepfeFilter.php');
        ?>
    </div>
    <div class="container" id="articleContainer">
        <?php
        $sql_result = get_coilVerdampferKoepfe($conn);
